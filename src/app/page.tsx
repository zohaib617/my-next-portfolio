...
const handleClick = () => {
  ...
  // Set a small delay to simulate the download process
  setTimeout(() => {
    window.location.href = "https://hackathone-milestone-1-2-coral.vercel.app/"; // Redirect to download link
  }, 1000); // Delay for 1 second to show "Downloading..."
};
    ...
    <h1 className=" text-4xl font-sans font-bold">
        ...
        <div className="text-white flex gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className=  " shadow-black shadow-xl w-full lg:w-[156px] h-[48px] text-sm lg:p-0 p-4 lg:text-lg  border-2 font-bold hover:text-white border-white rounded-md text-gray-400 hover:bg-[#CA5900] transition-colors"
      ...
      <button
        className=" shadow-black shadow-xl w-full lg:w-[209px] h-[48px] text-sm lg:p-0 p-4 lg:text-lg border-2 font-bold hover:text-white border-white rounded-md text-gray-400 hover:bg-[#CA5900] transition-colors"
        onClick={handleClick}
